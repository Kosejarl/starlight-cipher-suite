...
export const elements = {
    ...
    foursquareVariant: document.getElementById('foursquare-alphabet'),
    foursquareKey1: document.getElementById('foursquare-key1'),
    foursquareKey2: document.getElementById('foursquare-key2'),
    bifidVariant: document.getElementById('bifid-alphabet'),
    bifidKey: document.getElementById('bifid-key'),
    trifidKey: document.getElementById('trifid-key'),
    nihilistVariant: document.getElementById('nihilist-alphabet'),
    nihilistSquareKey: document.getElementById('nihilist-square-key'),
    nihilistAddKey: document.getElementById('nihilist-add-key'),
    ...
    hillError: document.getElementById('hill-error'),
    gronsfeldVariant: document.getElementById('gronsfeld-alphabet'),
    gronsfeldKey: document.getElementById('gronsfeld-key'),
    portaKey: document.getElementById('porta-key'),
    adfgvxVariant: document.getElementById('adfgvx-alphabet'),
    adfgvxGridKey: document.getElementById('adfgvx-grid-key'),
    adfgvxTransKey: document.getElementById('adfgvx-trans-key'),
