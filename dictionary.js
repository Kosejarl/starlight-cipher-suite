// 1000 Most Common English Words (Filtered for lengths 3 to 10)
export const COMMON_WORDS = [
  "the", "and", "for", "that", "you", "with", "this", "they", "have", "from",
  "word", "what", "were", "when", "your", "said", "there", "each", "which", "how",
  "their", "will", "other", "about", "many", "then", "them", "these", "some", "would",
  "make", "like", "into", "time", "look", "more", "write", "see", "number", "way",
  "could", "people", "than", "first", "water", "been", "call", "find", "long", "down",
  "day", "did", "get", "come", "made", "may", "part", "new", "work", "take",
  ...
  "same", "she", "all", "there", "use", "her", "tell", "boy", "follow", "came",
  ...
  "soon", "list", "song", "being", "leave", "family", "it", "is", "he", "was",
  ...
  "too", "mean", "old", "any", "same", "she", "all", "there", "use", "her",
  ...
  "far", "really", "almost", "let", "above", "girl", "sometimes", "mountain", "cut", "young",
  "talk", "soon", "list", "song", "being", "leave", "family", "body", "music", "color",
  "stand", "sun", "question", "fish", "area", "mark", "dog", "horse", "birds", "problem",
  "complete", "room", "knew", "since", "ever", "piece", "told", "usually", "didn", "friends",
  ...
  "passed", "vowel", "true", "hundred", "against", "pattern", "numeral", "table", "north", "slow",
  "money", "map", "farm", "leather", "pull", "voice", "seen", "cold", "cried", "plan",
  "notice", "south", "sing", "war", "ground", "fall", "king", "town", "ill", "unit",
  "figure", "certain", "field", "travel", "wood", "fire", "upon", "sing", "war", "ground",
  "fall", "king", "town", "ill", "unit", "figure", "certain", "field", "travel", "wood",
  "fire", "upon", "English", "road", "half", "ten", "fly", "gave", "box", "finally",
  ...
  "built", "starlight", "cipher", "suite", "test", "this", "hello", "world", "secret", "message"
];
